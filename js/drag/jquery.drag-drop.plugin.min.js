...
(c=h.clone(!1),c.appendTo('body'),b.sourceClass?h.addClass(b.sourceClass):b.sourceHide&&h.css("visibility","hidden")):c=h;c.css({position:"absolute",left:d.left,top:d.top,width:e,height:l});b.dragClass&&c.addClass(b.dragClass);if(b=b.container)d=b.offset(),j={minX:d.left,minY:d.top,maxX:d.left+b.outerWidth()-f.outerWidth(),maxY:d.top+b.outerHeight()-f.outerHeight()};i(window).bind("mousemove.dragdrop touchmove.dragdrop",{source:g},k.onMove).bind("mouseup.dragdrop touchend.dragdrop",{source:g},
